...
def benchmark_score_from_merged(
    benchmark, env_id, episode_lengths, episode_rewards, episode_types
):
...
def compute_graph_stats(
    episode_lengths, episode_rewards, timestamps, initial_reset_timestamp, buckets
):
    ...
    x_timestep_y_reward = scipy.stats.binned_statistic(
        x_timestep, episode_rewards, "mean", buckets
    )
    x_timestep_y_length = scipy.stats.binned_statistic(
        x_timestep, episode_lengths, "mean", buckets
    )

    x_episode_y_reward = scipy.stats.binned_statistic(
        x_episode, episode_rewards, "mean", buckets
    )
    x_episode_y_length = scipy.stats.binned_statistic(
        x_episode, episode_lengths, "mean", buckets
    )

    x_seconds_y_reward = scipy.stats.binned_statistic(
        x_seconds, episode_rewards, "mean", buckets
    )
    x_seconds_y_length = scipy.stats.binned_statistic(
        x_seconds, episode_lengths, "mean", buckets
    )
