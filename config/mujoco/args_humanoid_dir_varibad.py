...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--env_name", default="HumanoidDir-v0", help="environment to train on"
    )
    ...
    # PPO specific
    parser.add_argument(
        "--ppo_num_epochs", type=int, default=4, help="number of epochs per PPO update"
    )
    parser.add_argument(
        "--ppo_num_minibatch",
        type=int,
    ...
    parser.add_argument(
        "--policy_gamma", type=float, default=0.99, help="discount factor for rewards"
    )
    parser.add_argument(
        "--policy_use_gae",
        type=boolean_argument,
    ...
    parser.add_argument(
        "--encoder_max_grad_norm", type=float, default=1.0, help="max norm of gradients"
    )
    parser.add_argument(
        "--decoder_max_grad_norm", type=float, default=1.0, help="max norm of gradients"
    )
